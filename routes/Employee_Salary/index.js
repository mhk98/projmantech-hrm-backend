...
router.get("/", Employee_Salary.getEmployeeSalary);
router.get(
  "/allEmployeeSalary",

  Employee_Salary.getAllEmployeesalary
);
router.post(
  "/search",
  verifyToken,
  Employee_Salary.getIndividualEmployeeSalary
);
router.delete("/:id", verifyToken, Employee_Salary.deleteEmployeeSalary);
router.delete(
  "/search/:id",
  verifyToken,
  Employee_Salary.deleteSearchEmployeeSalary
);
